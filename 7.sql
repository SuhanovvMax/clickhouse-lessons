...
(1352564421, '2024-05-30 23:22:09', 'efsgjoisjg321gdsf31'),
(1354264421, '2024-05-30 23:04:50', 'efsgjoisjg3213dsa1');

select *
from stage.shk_ext_log;

create table currents.shk_ext_cur
(
    shk_id      Int64,
    dt          DateTime,
    ext_barcode String
...
drop view if exists stage.shk_ext_log_cur;
create materialized view stage.shk_ext_log_cur to currents.shk_ext_cur as
    select shk_id,
           dt,
           ext_barcode
    from stage.shk_ext_log;
...
show view stage.shk_ext_log_cur;


select *
from buf_.shk_ext_log;

select *
from stage.shk_ext_log;

select *
from currents.shk_ext_cur;
